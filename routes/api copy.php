...
Route::group(['middleware' => ['jwt.role:vendor', 'jwt.auth'], 'prefix' => 'vendor'], function ($router) {
    ...
    Route::get('/{vendorId}/machines/', [VendorMachineController::class, 'allVendorMachines']);
    Route::get('/{vendorId}/machine/{machineId}', [VendorMachineController::class, 'getVendorMachine']);
    Route::get('/refills/{machineId}', [VendorMachineController::class, 'getRefills']);
    Route::post('refill/', [VendorMachineController::class, 'saveRefill']);
...
// Route::get('/{vendorId}/machines/', [VendorMachineController::class, 'allVendorMachines']);
// Route::get('/{vendorId}/machine/{machineId}', [VendorMachineController::class, 'getVendorMachine']);
// Route::get('vendor/machine/{machineId}/refills', [VendorMachineController::class, 'getRefills']);
